...
class CreateRessarcimentoCobrancasDadosTable extends Migration
{
    public function up()
    {
        Schema::create('ressarcimento_cobrancas_dados', function (Blueprint $table) {
            ...
            $table->foreignId('ressarcimento_referencia_id')->constrained('ressarcimento_referencias', 'id', 'ressarcimento_cobrancas_dados.referencia_id');
            $table->foreignId('ressarcimento_orgao_id')->constrained('ressarcimento_orgaos', 'id', 'ressarcimento_cobrancas_dados.orgao_id');
            $table->foreignId('ressarcimento_militar_id')->constrained('ressarcimento_militares', 'id', 'ressarcimento_cobrancas_dados.militar_id');
            $table->foreignId('ressarcimento_pagamento_id')->constrained('ressarcimento_pagamentos', 'id', 'ressarcimento_cobrancas_dados.pagamento_id');
