...
class PermissoesSeeder extends Seeder
{
    public function run()
    {
        ...
        Permissao::create(['id' => 68, 'submodulo_id' => 15, 'name' => 'ressarcimento_relatorios_list', 'description' => 'Visualizar Registro - Ressarcimento Relatórios']);
        //Permissao::create(['id' => 69, 'submodulo_id' => 15, 'name' => 'ressarcimento_relatorios_create', 'description' => 'Criar Registro - Ressarcimento Relatórios']);
        //Permissao::create(['id' => 70, 'submodulo_id' => 15, 'name' => 'ressarcimento_relatorios_show', 'description' => 'Visualizar Registro - Ressarcimento Relatórios']);
