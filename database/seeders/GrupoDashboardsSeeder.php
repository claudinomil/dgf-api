...
class GrupoDashboardsSeeder extends Seeder
{
    public function run()
    {
        ...
        GrupoDashboard::create(['grupo_id' => 2, 'dashboard_id' => 6]);
        GrupoDashboard::create(['grupo_id' => 2, 'dashboard_id' => 7]);
        GrupoDashboard::create(['grupo_id' => 2, 'dashboard_id' => 8]);
        GrupoDashboard::create(['grupo_id' => 2, 'dashboard_id' => 9]);
        GrupoDashboard::create(['grupo_id' => 2, 'dashboard_id' => 10]);
        GrupoDashboard::create(['grupo_id' => 2, 'dashboard_id' => 11]);
        ...
        GrupoDashboard::create(['grupo_id' => 3, 'dashboard_id' => 6]);
        GrupoDashboard::create(['grupo_id' => 3, 'dashboard_id' => 7]);
        GrupoDashboard::create(['grupo_id' => 3, 'dashboard_id' => 8]);
        GrupoDashboard::create(['grupo_id' => 3, 'dashboard_id' => 9]);
        GrupoDashboard::create(['grupo_id' => 3, 'dashboard_id' => 10]);
        GrupoDashboard::create(['grupo_id' => 3, 'dashboard_id' => 11]);
        ...
        GrupoDashboard::create(['grupo_id' => 4, 'dashboard_id' => 6]);
        GrupoDashboard::create(['grupo_id' => 4, 'dashboard_id' => 7]);
        GrupoDashboard::create(['grupo_id' => 4, 'dashboard_id' => 8]);
        GrupoDashboard::create(['grupo_id' => 4, 'dashboard_id' => 9]);
        GrupoDashboard::create(['grupo_id' => 4, 'dashboard_id' => 10]);
        GrupoDashboard::create(['grupo_id' => 4, 'dashboard_id' => 11]);
        ...
        GrupoDashboard::create(['grupo_id' => 5, 'dashboard_id' => 6]);
        GrupoDashboard::create(['grupo_id' => 5, 'dashboard_id' => 7]);
        GrupoDashboard::create(['grupo_id' => 5, 'dashboard_id' => 8]);
        GrupoDashboard::create(['grupo_id' => 5, 'dashboard_id' => 9]);
        GrupoDashboard::create(['grupo_id' => 5, 'dashboard_id' => 10]);
        GrupoDashboard::create(['grupo_id' => 5, 'dashboard_id' => 11]);
        ...
        GrupoDashboard::create(['grupo_id' => 6, 'dashboard_id' => 6]);
        GrupoDashboard::create(['grupo_id' => 6, 'dashboard_id' => 7]);
        GrupoDashboard::create(['grupo_id' => 6, 'dashboard_id' => 8]);
        GrupoDashboard::create(['grupo_id' => 6, 'dashboard_id' => 9]);
        GrupoDashboard::create(['grupo_id' => 6, 'dashboard_id' => 10]);
        GrupoDashboard::create(['grupo_id' => 6, 'dashboard_id' => 11]);
    }
}
