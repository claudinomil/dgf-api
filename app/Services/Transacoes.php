        ...
        if ($userVerificado) {
            ...
            if ($submodulo_id == 10) {
                if ($op == 1) {
                    ...
                    $dados .= $this->retornaDado(1, $dadosAnterior['name'], $dadosAtual['name'], 'Nome', '', '');
                    $dados .= $this->retornaDado(1, $dadosAnterior['destinatario_pequeno'], $dadosAtual['destinatario_pequeno'], 'Destinatário Pequeno', '', '');
                    $dados .= $this->retornaDado(1, $dadosAnterior['destinatario_grande'], $dadosAtual['destinatario_grande'], 'Destinatário Grande', '', '');
