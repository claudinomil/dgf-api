...
class DashboardController extends Controller
{
    ...
    public function dashboard13($data1, $data2, $subconta_id)
    {
        ...
        //Retorno
        $dados['repasses'] = $registros[0]['repasses'];
    ...
    public function dashboard14($data1, $data2, $subconta_id)
    {
        ...
        //Retorno
        $dados['despesas'] = $registros[0]['despesas'];
    ...
    public function dashboard15($data1, $data2, $subconta_id)
    {
        ...
        //Retorno
        $dados['transferencias_realizadas'] = $registros[0]['transferencias_realizadas'];
    ...
    public function dashboard16($data1, $data2, $subconta_id)
    {
        ...
        //Retorno
        $dados['transferencias_recebidas'] = $registros[0]['transferencias_recebidas'];
    ...
    public function dashboards_views()
    {
        ...
        $dados['grupo_dashboards'] = GrupoDashboard
            ...
            ->select('dashboards.id as dashboard_id', 'dashboards.name as dashboard_name', 'dashboards.descricao as dashboard_descricao', 'agrupamentos.icone as dashboard_icone', 'agrupamentos.name as dashboard_agrupamento')
