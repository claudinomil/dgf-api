...
class RelatorioController extends Controller
{
    ...
    public function relatorios()
    {
        ...
        $content['agrupamentos'] = UserRelatorioViews
            ::join('relatorios', 'relatorios.id', '=', 'users_relatorios_views.relatorio_id')
            ...
            ->where('users_relatorios_views.user_id', Auth::user()->id)
