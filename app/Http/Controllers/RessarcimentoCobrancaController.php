...
class RessarcimentoCobrancaController extends Controller
{
    ...
    public function index($prefix_permissao)
    {
        ...
        return response()->json(ApiReturn::data('Dados enviados com sucesso.', 2000, null, $content), 200);
    }
    ...
    public function dados_ressarcimento($referencia)
    {
        ...
        foreach ($orgaos as $orgao) {
            ...
            if ($orgao['name'] == '' or $orgao['name'] === null
                ...
                or $orgao['destinatario_pequeno'] == '' or $orgao['destinatario_pequeno'] === null
                or $orgao['destinatario_grande'] == '' or $orgao['destinatario_grande'] === null
...
//                or $pagamento['nivel'] == '' or $pagamento['nivel'] === null
    ...
    public function gerar_cobrancas($referencia)
    {
        ...
        foreach ($reg_orgaos as $reg_orgao) {
            ...
            $data['orgao_destinatario_pequeno'] = $reg_orgao['destinatario_pequeno'];
            $data['orgao_destinatario_grande'] = $reg_orgao['destinatario_grande'];
            ...
            RessarcimentoCobrancaPdfOficio::create([
                ...
                'orgao_destinatario_pequeno' => $data['orgao_destinatario_pequeno'],
                'orgao_destinatario_grande' => $data['orgao_destinatario_grande'],
